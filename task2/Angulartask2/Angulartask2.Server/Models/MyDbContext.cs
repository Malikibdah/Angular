...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-G7O24FF;Database=ServiceDB;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Service>(entity =>
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Service__4550733F739B24AE");
        ...
        {
            entity.HasKey(e => e.SubServiceId).HasName("PK__subServi__C5C51FFA0759A38A");
        ...
        {
            entity.HasKey(e => e.SubscriptionId).HasName("PK__subscrip__4A0F55C7A438437A");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC9B3C5A8D");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534C83C58F3").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__user_sub__3213E83F96E13DA4");
            ...
            entity.HasOne(d => d.Subscription).WithMany(p => p.UserSubscriptions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_subs__subsc__52593CB8");

            entity.HasOne(d => d.User).WithMany(p => p.UserSubscriptions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_subs__userI__5165187F");
        });
